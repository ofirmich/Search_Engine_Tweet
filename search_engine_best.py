...
class SearchEngine:
    ...
    def load_precomputed_model(self, model_dir=None):
        ...
        """
        self._model = gensim.models.KeyedVectors.load_word2vec_format(os.path.join(model_dir, "model_word2vec_last"),binary=True,encoding='utf-8', unicode_errors='ignore')
